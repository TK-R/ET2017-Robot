...
private:
	...
	PIDDataManager()
	{
		// PIDDataの初期値を登録
		// 直線				
		PIDData lineLineTraceStraight = {100, 0.1034483, 0, 0.3218391, LineTraceStraight, 0};
		...
		PIDData linepLast = {71.26437, 0.1551724, 0, 0.2758621, pLast, 30};
		SetPIDData(linepLast);
